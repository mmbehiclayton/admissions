            ...
            <div class="w-full overflow-x-auto">
                <div class="grid grid-cols-3 gap-4 px-3 pt-3">
                    ...
                    <div class="flex items-center justify-between px-4 py-3">
                        ...
                        <span> <select name="branch_id" id="select" class="block w-full text-sm border-r-2 border-gray-950 dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
